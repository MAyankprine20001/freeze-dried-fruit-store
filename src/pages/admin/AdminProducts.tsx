                ...
                <div>
                  ...
                  <div className="space-y-4">
                     ...
                     <p className="text-[#6c757d] text-sm leading-relaxed">
                       {previewProduct.description || "Our premium freeze-dried fruits are harvested at peak ripeness and processed using advanced cold-press technology to preserve 97% of vitamins, minerals, and flavor. No added sugars, no preservatives—just the pure essence of nature."}
                     </p>
                  </div>
                </div>
